...
{
    public class SendPurchaseRequestValidator : AbstractValidator<SendPurchaseRequestDto>
    {
        public SendPurchaseRequestValidator()
        {
            ...
            RuleFor(x => x.Text).MinimumLength(100)
                .WithMessage("O campo {PropertyName} necessita de no mínimo 100 caracteres!")
                .WithName("Mensagem");
        }
    }
}
